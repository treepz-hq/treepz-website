    ...
    <div className="container px-4 sm:px-20 flex justify-between mb-[90px]">
        <div className='flex justify-between gap-16 mt-14 sm:mt-28 '>
            ...
            <div className="flex flex-col items-center space-y-6 w-full sm:w-[700px] text-center relative mx-[82px]">
                ...
                <p className="text-2xl sm:text-[32px] leading-[40px] text-[#212529] font-medium">Treepz was founded by four entrepreneurs who were tired of the broken transport system in Africa and wanted to make a change.</p>
